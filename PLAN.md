...
13. **Deduplicate agents + runners** — ✅ **complete** **[R-M9]**
...
15. **Dashboard + control (Docker WebUI)** 🔨 in progress (P1+P2 done: control table + agent checks + control API; P3–P5 remaining: dashboard pages, config UI, Docker) — design in §"Data Pipeline, Storage & Dashboard (Week 6)"
