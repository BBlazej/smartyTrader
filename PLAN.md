...
storage:
  ...
  snapshot_retention_days: 30   # market snapshots pruned by default (§7.12)
  history_retention_days: 0     # decisions/orders: 0 = keep forever
  prune_interval_minutes: 1440  # runners also prune at startup, always
...
12. **Storage retention / pruning** — ✅ **complete** **[R-M8]**
